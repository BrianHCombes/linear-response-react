    ...
    <React.StrictMode>  
      ...
      <div style={{width:'95%', margin:'1% auto 0 auto'}}>    
        <div style={{color:'white', fontSize:'1.00em', fontFamily:'Arial Rounded MT Bold'}}>
          The above LR settings (setters) tells LR to use 1170px as its custom upper viewport width (is also the upper range point for width) 
          and 400px as its custom lower viewport width (is also the lower range point for width). These settings are internal to LR so 
      ...
      <table style={{ border:'2px solid black', 
        ...
        <tr>
          ...
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
        ...
        <tr>
          ...
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
          Sets LR's recognized <span style={{color:'red'}}><b>upper</b></span> viewport width (arg is in pixels, number only) to establish LR's upper range point for width.
          </td>
        </tr>  
        <tr>
          <td style={{width:'20%', padding:'1%', fontSize:'1.5em', fontFamily:'monospace', backgroundColor:'#ccddcc'}}>
          ...
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
            Sets LR's recognized <span style={{color:'blue'}}><b>lower</b></span> viewport width (arg is in pixels, number only) to establish LR's lower range point for width.
          </td>
        </tr>
        <br />
        <tr>
          ...
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
            Sets LR's recognized <span style={{color:'red'}}><b>upper</b></span> viewport height (arg is in pixels, number only) to establish LR's upper range point for height.
          </td>
        </tr>
        <tr>
          <td style={{width:'20%', padding:'1%', fontSize:'1.5em', fontFamily:'monospace', backgroundColor:'#ccddcc'}}>
          ...
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
            Sets LR's recognized <span style={{color:'blue'}}><b>lower</b></span> viewport height (arg is in pixels, number only) to establish LR's lower range point for height.
          </td>
        </tr>
        <br />
      </table>
      ...
      <table style={{ border:'2px solid black', 
        ...
        <tr>
          <td style={{padding:'2% 1% 2% 1%', verticalAlign:'top', fontSize:'1.5em', fontFamily:'monospace', backgroundColor:'#ccddcc'}}>
        ...
        <tr>
          ...
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
            Tells LR to use the <span style={{color:'red'}}>width</span> of the screen (excluding the Windows Taskbar) to calculate the proper response.
          </td>
        </tr> 
        <tr>
          <td style={{padding:'1%', fontSize:'1.5em', fontFamily:'monospace', backgroundColor:'#ccddcc'}}>
          ...
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
            Tells LR to use the <span style={{color:'blue'}}>height</span> of the screen (excluding the Windows Taskbar) to calculate the proper response.
          </td>
        </tr> 
        <br />
      </table>
      ...
      <table style={{ border:'2px solid black', 
        ...
        <tr>
          <td style={{width:'50%', padding:'2% 1% 2% 1%', fontSize:'1.5em', fontFamily:'monospace', backgroundColor:'#ccddcc'}}>
            <a href="#" style={{textDecoration:'none', color:'red'}}><b>lr.toConsole</b></a>
          </td>
          <td style={{padding:'1%', verticalAlign:'middle', backgroundColor:'#ccddcc'}}>
          Sends a full property settings report to the console.
          </td>
        </tr> 
        ...
        <tr>
          <td style={{padding:'1%', fontSize:'1.5em', fontFamily:'monospace', backgroundColor:'#ccddcc'}}>
            <a href="#" style={{textDecoration:'none', color:'red'}}><b>lr.getLRp().lrDeviceWidth</b></a>
          </td>
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
        ...
        <tr>
          <td style={{padding:'1%', fontSize:'1.5em', fontFamily:'monospace', backgroundColor:'#ccddcc'}}>
            <a href="#" style={{textDecoration:'none', color:'blue'}}><b>lr.getLRp().lrDeviceWidthPropertyApplied</b></a>
          </td>
          <td style={{padding:'1%', verticalAlign:'top', backgroundColor:'#ccddcc'}}>
